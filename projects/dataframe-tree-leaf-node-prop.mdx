...
date: "2021-05-15"
description: "In a very niche use case where RPart Decision trees are converted to dataframes, propogating values up the leaf nodes proved to be difficult. I wrote a neat algorithm that self-joins the tree dataframe such that it propogates values all the way to the root."
frontPage: true
