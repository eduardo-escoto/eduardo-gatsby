...
date: "2021-07-20"
description: "An end to end modeling pipeline implementation of a Recurrent Neural Network tha learns word embeddings and outputs a continuous prediction. Trains, Validates, and Predicts automatically."
frontPage: true
featuredImage: "../images/model_square.png"
